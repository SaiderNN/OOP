    ...
    public partial class Form1 : Form
    {
        ...
        private void btnFillRandom_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < MatrixA.RowCount; i++)
            {
                ...
                {
                    MatrixA.Rows[i].Cells[j].Value = Convert.ToDouble(rnd.Next(-100, 100));
                }
            }
            for (int i = 0; i < MatrixB.RowCount; i++)
            {
                ...
                {
                    MatrixB.Rows[i].Cells[j].Value = Convert.ToDouble(rnd.Next(-100, 100));
                }
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Количество столбцов в 1 матрице должно быть равно количеству строк во 2 матрице!!!");
            }
